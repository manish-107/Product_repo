            ...
            <form className='flex items-center justify-center mt-10 ' onSubmit={handleSubmit}>
                <div className='w-3/5 p-8 rounded-lg shadow-md gap-y-1 gap-x-10 bg-gray-2 00 sm:grid-cols-1 lg:grid-cols-2 sm:grid lg:grid bg-slate-300'>
                    ...
                    <div className="mb-4">
                        ...
                        <input type="number" id="price" name="price" placeholder="Enter the text" className="block w-full p-1 mt-1 border border-gray-300 rounded-md shadow-sm form-input" />
                    </div>
                    <div className="mb-4">
                        <label htmlFor="brand" className="block font-semibold text-gray-700">Brand:</label>
                        <input type="text" id="brand" name="brand" placeholder="Enter the text" className="block w-full p-1 mt-1 border border-gray-300 rounded-md shadow-sm form-input" />
                    </div>
                    <div className="mb-4">
                        <label htmlFor="category" className="block font-semibold text-gray-700">Category:</label>
                        <input type="text" id="category" name="category" placeholder="Enter the text" className="block w-full p-1 mt-1 border border-gray-300 rounded-md shadow-sm form-input" />
                    </div>
                    <div className="mb-4">
                        <label htmlFor="stock" className="block font-semibold text-gray-700">Stock:</label>
                        <input type="number" id="stock" name="stock" placeholder="Enter the text" className="block w-full p-1 mt-1 border border-gray-300 rounded-md shadow-sm form-input" />
                    </div>
                    <div className="mb-4">
                        <label htmlFor="discountpercentage" className="block font-semibold text-gray-700">DiscountPercentage:</label>
                        <input type="number" id="discountpercentage" name="discountpercentage" placeholder="Enter the text" className="block w-full p-1 mt-1 border border-gray-300 rounded-md shadow-sm form-input" />
                    </div>
                    <div className="col-span-2 mb-4">
                        <label htmlFor="image" className="block font-semibold text-gray-700">Image Link:</label>
                        <input type="text" id="image" name="image" placeholder="Enter the text" className="block w-full p-1 mt-1 border border-gray-300 rounded-md shadow-sm form-input" />
                    </div>
                    <div className="col-span-2 mb-4">
                        <label htmlFor="desc" className="block font-semibold text-gray-700">Description:</label>
                        <input type="text" id="desc" name="desc" className="block w-full h-16 p-1 mt-1 border border-gray-300 rounded-md shadow-sm form-input" />
                    </div>
